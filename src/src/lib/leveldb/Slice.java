...
public class Slice {
    ...
    /**
     * Two Slice references are equal if:
     * 1) they point to the same byte array span, or
     * 2) they have the same byte length and hash value
     *
     * @param  o  the other Slice reference
     * @return true if Slice's are equal, false otherwise
     */
    @Override
